...
public class MethodActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        for(int i =0; i < dataList.size(); i++){
            ...
            if(!method_list.contains(dataList.get(i)[18]))
                method_list.add(dataList.get(i)[18]);
        }
        ...
        ArrayAdapter adapter = new ArrayAdapter(this, android.R.layout.simple_list_item_1, method_list) ;
    ...
    public void onResume() {
        super.onResume();
            ...
            textView = (TextView) findViewById(R.id.textCurrentSelect) ;
            textView.setText("공종분류 : " + construction + "\n작업프로세스 : " + process + "\n위험발생객체 : " + hazard + "\n위험발생위치 : " + hazard_position + "\n인적피해 : " + damage);
            listView = (ListView) findViewById(R.id.method_list);
